                ...
                <div className="relative mx-auto w-full">
                    ...
                    <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm ">
                        ...
                        <div className="p-5">
                            ...
                            <a href="#" className="text-white bg-[#389E0D] dark:bg-[#389E0D] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-[#389E0D] dark:hover:bg-[#298403] dark:focus:ring-blue-800">
                                Read more
