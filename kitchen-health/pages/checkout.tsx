            ...
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              <div className="flex flex-col rounded-lg bg-white sm:flex-row">
                ...
                <button type="button" className="ml-80">
                  <img
                    src="\assets\loginRegisterPage\pilih.png"
                    className="w-12"
                    alt=""
                  />
                </button>
          ...
          <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              <img
                ...
                src="\assets\loginRegisterPage\bayam.png"
                alt=""
              />
              <div className="flex w-full flex-col px-4 py-4 justify-center">
                ...
                <p className="text-lg font-bold relative">
                  Rp10.000
                  <span className="float-right text-gray-400 text-right sm:top-auto">
                    1x
                  </span>
                </p>
              </div>
            ...
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              <img
                className="m-2 h-24 w-28 rounded-md border object-cover object-center"
                src="\assets\loginRegisterPage\capcay.png"
                alt=""
              />
              <div className="flex w-full flex-col px-4 py-4 justify-center">
            ...
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              <img
                className="m-2 h-24 w-28 rounded-md border object-cover object-center"
                src="\assets\loginRegisterPage\kentang.png"
                alt=""
              />
              <div className="flex w-full flex-col px-4 py-4 justify-center">
          ...
          <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              <div className="flex items-center justify-between">
                ...
                <p className="text-xl font-semibold text-gray-900 ml-96">
                  <span className="text-xs font-normal text-gray-400 ml-12">
                    Rp
                  </span>{" "}
                  45.000
                </p>
